...
function darkMode(){
	if(BACKGROUND_COLOR != 5){
		...
		document.body.style.backgroundColor = "#c9d1ff";
...
function testAlg(){
	...
	else if(canMan && customb == 0)
	{
		...
		else if (inp.value() == "moley" || inp.value() == "Moley") {
			alert("I guess all moleys are such moleys");
			return;
		}
